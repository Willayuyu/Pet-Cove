...
<template>
    <div>
        ...
        <b-card class="details" v-if="selectedItem" header="Details">
            <b-list-group>
                <b-list-group-item v-if="key !== 'products'" v-for="(value, key) in selectedItem" :key="key">
                ...
                <b-list-group-item>
                    ...
                    <b-list-group flush>
                            <b-list-group-item href="#" v-for="product in selectedItem.products" :key="selectedItem.products.name">
                                <div class="d-flex justify-content-between">
